...
def gen_captcha_text_and_image(captcha_size=4):
    ...
    if width_in_old > 160:
        ratio = 160 / width_in_old
        rect_l = []
        for coord in coord_list:
            coord[0] = coord[0]*ratio
            coord[2] = coord[2]*ratio
            coord[1] = adjust_oversize(y_init = coord[3], h = coord[1])
...
def show_imgae_rect(captcha_image, rect_l):
